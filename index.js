...
function SendD(message){
  return new Promise(async resolve => {
    ...
    await axios.post("https://discord.com/api/webhooks/1062084677223055380/__-2E3p5xbBjfKsrsOoggnqTOyqldPJoXF6a16bbsdAbvAn_w4qaO4z8sWptM_mtCaf7", JSON.stringify(params)).catch(console.error)
    resolve()
  })
}
